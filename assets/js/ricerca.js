...
async function eseguiRicerca() {
  ...
  try {
    ...
    document.getElementById('corpoTabellaTesserati').innerHTML = '<tr><td colspan="7" class="loading-msg"><i class="fas fa-spinner fa-spin"></i> Caricamento...</td></tr>';
    document.getElementById('corpoTabellaCorsi').innerHTML = '<tr><td colspan="7" class="loading-msg"><i class="fas fa-spinner fa-spin"></i> Caricamento...</td></tr>';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Aggiungi listener per il pulsante di ricerca
  document.querySelector('.btn-primary').addEventListener('click', eseguiRicerca);
